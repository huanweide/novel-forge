...
> **当前版本 v3.1.27（探讨模式 AI 未配置时诚实提示·体验修复·亲自走查）** · 选文体先进探讨模式把世界观/角色聊清楚再写 · 探讨每一步给出「该聊什么」+ 示例提问 · 开箱即带 15 个示范预设（套用即开写，免手填表）· 一键示例小说 · 8 题材开局 · 6 格式导出 · 长篇小说不降智（分层记忆 + AI 远楼层压缩）· 批量写作 · 故事线缝合怪 · 世界卡 15 分类体系 · 故事线进度量化。
