...
- 正文直接切入场景——第一句必须是动作或冲突对话`,
  ...
  },
  {
    id: "xianxia",
    name: "古风仙侠",
    description: "半文半白古风，修仙体系严密。适合传统仙侠、修真、玄幻。",
    icon: "⛰️",
    stylePrompt: `你正在写一部古风仙侠小说。

文风要求：
- 半文半白，叙述简洁有力，避免过于现代化的表达
- 修仙体系严密——境界、功法、丹药、法宝的设定前后一致
- 战斗描写有画面感和力量感——不是"一招打飞"，是法力碰撞/法器对抗/灵力透支
- 环境描写有意境——云海翻涌、灵雾弥漫、古木参天，写出修仙世界的仙气
- 对话古雅——根据角色身份区分语域：前辈用敬语、同辈可随意、晚辈要谦恭
- 节奏张弛有度——修炼日常的平淡 vs 秘境险境的紧张交替`,
    temperature: 0.85,
    topP: 0.92,
    targetWordsPerSection: 1500,
    forbiddenPatterns: [
    ...
    pacingGuide: "修炼→冲突→机缘→突破→新危机。每章至少一个修仙元素（功法/丹药/法宝/秘境）。",
    dialogueGuide: "前辈用古语（本座/罢了/有趣），晚辈用敬语（师尊/师叔），平辈可随意。对话不超3句连发。",
    descriptionDensity: 7,
  },
  {
    id: "modern_urban",
    name: "现代都市",
    description: "现代背景、贴近生活。适合都市、职场、校园、恋爱。",
    icon: "🏙️",
    stylePrompt: `你正在写一部现代都市小说。

文风要求：
- 语言贴近当代中文——自然口语化但不粗俗，拒绝翻译腔
- 环境描写有现代感——地铁、写字楼、便利店、手机屏幕的光，读者一眼就知道"这是现在"
- 对话是核心驱动力——角色说话各有风格，信息在对话中自然推进
- 内心戏丰富但不啰嗦——主角怎么看待这个城市、这份工作、这段关系
- 节奏明快——不拖戏，每个场景有明确的信息推进`,
    temperature: 0.85,
    topP: 0.93,
    targetWordsPerSection: 1200,
    forbiddenPatterns: [
    ...
    pacingGuide: "场景驱动——一个场景一个核心冲突，自然过渡到下一个。拒绝大段环境描写开篇。",
    dialogueGuide: "对话占比50%以上。角色口癖要自然——不是刻意搞笑，是这个人就这样说话。",
    descriptionDensity: 5,
  },
  {
    id: "custom",
