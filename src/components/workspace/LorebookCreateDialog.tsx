    ...
    <DialogOverlay onClose={onClose}>
      ...
      <div className="space-y-3">
        ...
        <DialogField label="设定内容">
          <textarea className="w-full bg-zinc-800 border border-zinc-700 rounded px-3 py-2 text-sm resize-none" rows={4} value={form.content} onChange={(e) => setForm({ ...form, content: e.target.value })} placeholder="详细描述这个设定的内容..." />
        </DialogField>
      </div>
