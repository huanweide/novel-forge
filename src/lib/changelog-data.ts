...
export const LATEST_VERSION = "v0.46.3";

/** 首页公告弹窗摘要（只列最新版本的关键项） */
export const CHANGELOG_BRIEF = [
  "📦 创意工坊「开箱即用」：全新本地安装首次打开创意工坊，即自动载入全部系统示范预设，不再需要手动点「载入示范预设」——系统预设人人可用",
  "🌐 系统预设随软件分发：16 个内置预设（含舞台剧风格、古风文笔、仙侠/西幻世界观、角色卡、表格模板等）写进代码 BUILTINS，任何本地部署都自动拥有；自动播种接口按 {type,title,isBuiltin} 去重，重复触发安全",
  "🔒 上传弹窗新增隐私说明：你上传的预设仅保存在本机数据库，不上传任何服务器、不与他人共享——纯粹方便你自己随时套用",
  "🧪 确认无 bug：tsc 零错误；创意工坊共享模型厘清——系统预设人人可用、用户上传仅本机个人，跨机器天然隔离（单用户本地部署，无共享库）",
];
