...
export const LATEST_VERSION = "v3.1.6";

/** 首页公告弹窗摘要（只列最新版本的关键项） */
export const CHANGELOG_BRIEF = [
  "v3.1.6 全站离谱色收口 + 界面设计体系文档化（UI 设计师·虚空玻璃体系·收尾）：①离谱色收口——把 v3.1.0 收官后残留的三处紫/粉离谱色（导入向导 ImportWizard 的角色/A路识别色、探索构建 BuildConfigPanel 的 purple/pink 芯片色、设置导入 SettingsImporter 的风格卡计数色）统一收进单一身份色香槟金 --nv-creative，全站配色彻底收敛为「主色/成功/警告/危险/创意金」五语义色，不再有游离的紫粉；②实体高亮测试补锁——给被正文实体高亮重度消费的 src/core/entity-highlighter.ts 补 13 例自动化测试（最长名优先/重叠占用/头边界/停用词过滤/buildEntityMapFromData 别名与覆盖/getCategoryColor 固定色兜底），钉死高亮命中契约；③README 新增「界面与设计体系」章节，把虚空玻璃（无色玻璃身份、非廉价彩色滤纸）、香槟金单一身份色、全站转场（切页轻淡入转屏）、免糊窗毛玻璃、微交互（按钮金环按压/卡片浮起描边发光/错峰入场）体系化说明，让贡献者一眼看懂设计语言；④质量门禁——tsc 0 错误；vitest 全量 115 文件 1190/1190 全绿（较 v3.1.5 基线 115 文件 1177 +13 例）；六版本文件对齐 v3.1.6；个人 IP 仍归瑞宝宝，无新 IP/品牌/引流。",
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "tsc 0 错误；vitest 全量 115 文件 1190/1190 全绿（较 v3.1.5 基线 115 文件 1177 +13 例）；六版本文件对齐 v3.1.6；个人 IP 仍归瑞宝宝，无新 IP/品牌/引流",
        ],
      },
    ],
  },
