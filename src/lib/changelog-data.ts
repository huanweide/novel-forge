...
export const LATEST_VERSION = "v0.46.45";

/** 首页公告弹窗摘要（只列最新版本的关键项） */
export const CHANGELOG_BRIEF = [
  "纸舟星海 maxloop 第1轮：用参数驱动 BoatFactory 替换单一折纸船，落地 6 种可一眼辨识的真实船型——乌篷/楼船/帆船/渔船/龙舟/机关舟；船型由题材反向编码（船型即语义），非用户自选",
  "性能纪律：全局真 PointLight 封顶 8 个（仅焦点船+最近/最活跃），其余船头用发光球+加性光晕 sprite 假光；共享船体/帆/篷材质，单船顶点远低于 800，杜绝每船独立几何+独立灯",
  "结构真实三要素（费曼验收）：比例正确（楼船宽底防翻、龙舟极窄长、乌篷半圆篷）、部件连接自洽（桅杆连承重、网具下垂）、光影诚实（真灯船灯亮则船身受光）；保留船大小=字数/灯亮=活跃度/光尾=连续性/折痕光=题材色语义",
  "诚实边界：tsc 零错误 + dev 200 + SSR 含「纸舟星海/选择一本书」标记；3D 观感（船型轮廓辨识度、墨色材质统一度）需浏览器实跑/用户验收，第2轮聚焦高模+真灯受光、第3轮 LOD+实例化收口",
];
