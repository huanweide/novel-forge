...
export const LATEST_VERSION = "v1.8.3";

/** 首页公告弹窗摘要（只列最新版本的关键项） */
export const CHANGELOG_BRIEF = [
  "v1.8.3 全站中间态编辑弹窗统一美化：词条编辑 / 角色编辑改为居中玻璃面板 + 分区卡片 + 统一图标/字阶/按钮，与故事线工作台风格一致",
  "v1.8.3 AI 填满按钮升级为高可见状态：显示 spinner + 状态文字，保留在标题栏，避免与保存按钮混淆",
  "v1.8.3 故事线工作台重构：点击主线/支线后弹出居中玻璃面板，左侧导航 + 右侧查看/编辑整合，告别左栏缩成一团",
  "v1.8.3 验证：tsc --noEmit 0 错 + vitest 358/358 全绿 + 无头浏览器截图验证词条编辑/角色编辑新 UI",
];
