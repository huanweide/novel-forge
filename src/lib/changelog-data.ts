...
export const LATEST_VERSION = "v2.0.1";

/** 首页公告弹窗摘要（只列最新版本的关键项） */
export const CHANGELOG_BRIEF = [
  "v2.0.1 摘要大纲根治：聚合层下沉为纯函数 digest-aggregate，从源头过滤 AI 对空/模板内容生成的「元应答」残片（如「您提供的章节内容似乎为空」），时间线摘要大纲不再吐模板。",
  "v2.0.1 同章去重 + 标题归一：每章只保留「非垃圾且最长」一条摘要，循环剥离标题自带「第X章」前缀（中/阿数字），不再出现三重前缀叠加。",
  "v2.0.1 入口拦截新脏数据：summarize 路由与 post-processor 摘要落库前加 isGarbageSummary 守卫，命中即拒收、不落库、不重建大纲。",
  "v2.0.1 受影响库一次性清理：新城·龙陨之地 / 星辰 重复与垃圾摘要行已清理并重算大纲，打开即干净；新增 14 条单测覆盖去重/垃圾过滤/标题归一。",
];
