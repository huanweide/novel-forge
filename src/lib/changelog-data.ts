...
export const LATEST_VERSION = "v0.46.51";

/** 首页公告弹窗摘要（只列最新版本的关键项） */
export const CHANGELOG_BRIEF = [
  "纸舟星海换回真实船型（用户指令：还是不要纸船了，设计成真实的船型）：乌篷/楼船/帆船/渔船/龙舟/机关舟六种实体船模——楼船飞檐暗窗顶饰、龙首下颌双眼鬃毛、帆船桅索、渔船吊杆网具舱房、龙舟鼓+尾鳍+坐板、机关舟金属侧鳍天线",
  "材质升级为真实质感：船体浅木纹（真实木船）、木料深木纹、帆布纹、乌篷竹篾纹、机关舟金属壳、楼船墨红旗——删除宣纸纹与整套折纸工具，船从「纸片」变回「有体积的真实船」",
  "交互与视觉全部保留：漫画风格海面（亮蓝+浪花线+同心波纹）、拖拽旋转/滚轮缩放、悬浮见书名、点击弹确认「你确认要进入《书名》吗？」、从上方掉落+落水扑通、真灯池 ≤8 灯亮船身受光",
  "预览文件同步重写（真实船+漫画海+确认+悬浮书名+书架示意）；tsc 零错误 + dev 200 自查通过",
];
