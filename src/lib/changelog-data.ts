...
export const LATEST_VERSION = "v0.27.1";

/** 首页公告弹窗摘要（只列最新版本的关键项） */
export const CHANGELOG_BRIEF = [
  "🐛 修复自动填表多行覆盖：同表多次 insert 现正确累积，宫斗 4 位妃嫔全部入表",
  "🗂 宝宝流内核稳定：结构化表格 + LLM 填表 + 记忆召回 端到端验证通过",
  "✅ 生产构建通过：TypeScript 类型检查 + 69 页静态生成，可直接部署",
  "🛍 创意工坊预设（表格模板/剧情推进/文风/世界观/角色卡）可上传共享与复刻（免费）",
];
