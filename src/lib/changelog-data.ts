...
export const LATEST_VERSION = "v0.46.46";

/** 首页公告弹窗摘要（只列最新版本的关键项） */
export const CHANGELOG_BRIEF = [
  "去花哨·回到实用版型：移除首页极光背景 AuroraBackground、星尘粒子 ParticleField、Hero 光晕与轨道装饰；纸舟海面移除发光光晕 sprite、光尾、涟漪、航线光带与星点——回到云笔式内容优先、书本网格为主的干净版型（对标参考作者云笔 AI 小说设计）",
  "保留 3D 模型动态与真实细节：6 种真实船型（乌篷/楼船/帆船/渔船/龙舟/机关舟）含高模细节（楼船飞檐暗窗顶饰、龙首下颌双眼鬃毛、楼船墨红旗、渔船渔网、龙舟鼓与尾鳍、机关舟侧鳍天线），随墨海轻轻起伏摇曳；全局真 PointLight 仍封顶 8，灯亮则船身受光",
  "显示所有书（含旧设置项目）：首页 /api/projects 全量列出；ProjectCard「进入工作台 →」与纸舟书栏选书均正确路由到 /workspace/{id}（已验证 200）；3D 小船点选聚焦亦可「打开这本书」",
  "诚实边界：tsc 零错误 + dev 200 + SSR 无极光/粒子/光晕残留标记；修复渔网贴图在模块顶层调用 document 导致的 SSR 报错（改为客户端惰性创建）；3D 观感仍需浏览器实跑验收",
];
