...
export const CHANGELOG_BRIEF = [
  "🤖 AI扩展防卡死——120s单角色超时+并发降6+原文截断8000，不再戛然而止",
  ...
  "📥 导入全面修复——Markdown标题/中文数字/序数全兼容，描述整段塞background不拆解",
];
...
export const VERSIONS: VersionEntry[] = [
  {
    version: "v0.12.1",
    date: "2026-06-10",
    title: "AI扩展防卡死 + 自动分类AI三分类 + 扩展维度升级",
    sections: [
      {
        label: "🤖 AI扩展防卡死（3层保护）",
        items: [
          "120s单角色AbortController超时——单个卡住不影响全局，超时自动跳过继续下一个",
          "并发从10降到6——避免触发硅基流动Flash API限流导致批量卡死",
          "原文截断8000字——超长导入文本是API慢响应的主因，截断大幅提速",
          "超时错误信息明确标注「该角色跳过，不影响其他」——不再静默卡死",
        ],
      },
      {
        label: "🏷 自动分类全面升级",
