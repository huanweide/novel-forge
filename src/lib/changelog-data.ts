...
export const CHANGELOG_BRIEF = [
  "v2.0.0 质量总分聚合条：PostGenPanel 顶部新增质量总分聚合条，把正文质检 / 一致性 / 安全 / 节奏等维度汇总为一目了然的总分与分项状态。",
  "v2.0.0 安全规则库用户可配置：内容安全「安全」Tab 支持在不可删的默认基线之上，叠加你的专属增量黑名单（关键词/短语 + 分类 + 严重度），扫描时自动合并、零 token。",
  "v2.0.0 记忆透出合并单组件：右栏「统计 → 上下文监控」合并原独立的宝宝流记忆召回面板，生成时自动展开、平时收起，单一入口看全上下文与记忆注入。",
  "v2.0.0 收口与展示：轻量章纲降级为「快速预览」；右栏实体三子 Tab 标注结构化表同源切片；写作页标题区被动展示全书叙事阶段名（开篇/中期/高潮…）· 进度%。",
];
