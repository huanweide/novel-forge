...
export const LATEST_VERSION = "v1.5.0";

/** 首页公告弹窗摘要（只列最新版本的关键项） */
export const CHANGELOG_BRIEF = [
  "v1.5.0 批量写作上线：选 1-10 章+作者指令→后台逐章建章生成（自动章名/填表/审阅），右下角进度可关窗口",
  "故事线 UI 升级：卡片一键完成打勾（主线完结自动缝合新主线）+ 章节进展时间轴（自动回写的大事件）",
  "生成确认极简化：删复杂角色调度列表/备注/自建，只留「人物」输入+作者指令+确认",
  "tsc 零错误 + 217 测试全绿",
];
