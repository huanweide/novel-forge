...
export const LATEST_VERSION = "v1.1.5";

/** 首页公告弹窗摘要（只列最新版本的关键项） */
export const CHANGELOG_BRIEF = [
  "v1.1.5 正文区彻底清爽：下方确认流程常驻栏整体移除，收口到「项目设定」弹窗的确认与交付分区，正文阅读零遮挡",
  "确认流程全部能力（定稿/提交/打回/AI审校/人工接管/智能交付全书/两开关）内置设置弹窗，未选中章节给引导，功能零丢失",
  "章纲确认默认收起为可选步骤，「生成/重写」一键直出正文，不再强制先走章纲",
  "tsc 零错误 + 217 测试全绿",
];
